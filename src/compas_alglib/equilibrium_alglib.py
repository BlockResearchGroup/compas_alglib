...
__all__ = ['shell_update_xyz_alglib']
...
def shell_update_xyz_alglib(mesh, density=1.0, kmax=10):
    ...
    ij_q = {uv: mesh.edge_attribute(uv, 'q', 1.0) for uv in mesh.edges()}
    ...
    for u, v in mesh.edges():
        ...
        f = q * l
        mesh.edge_attributes((u, v), ('q', 'f', 'l'), (q, f, l))
...
def _selfweight_calculator(mesh, density=1.0):
    ...
    ro = [attr['c1'] * density for key, attr in mesh.vertices(True)]
